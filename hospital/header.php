...
<head>
  ...
  <title>HMS - Hospital Dashboard</title>
 ...
 <!-- ======= Header ======= -->
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow notifications">
            ...
            <li class="notification-item">
              ...
              <div>
                <h4>New Hospitals added</h4>
                <p>Browse Hospitals tab for more info</p>
                <p>30 min. ago</p>
              </div>
            </li>
            ...
            <li class="notification-item">
              ...
              <div>
                ...
                <p>A hospital's request was denied</p>
                <p>1 hr. ago</p>
              </div>
            </li>
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="hospital_profile.php">
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
     ...
     <li class="nav-item">
        <a class="nav-link collapsed" href="admin/vaccines.php">
          <i class="bi bi-person"></i>
          <span>Vaccines</span>
        </a>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="hospital_profile.php">
          <i class="bi bi-person"></i>
          <span>Profile</span>
        </a>
      </li><!-- End Profile Page Nav -->
